...
Artifact attestations/provenance for release artifacts are tracked separately by #133. The v1.0 RC checklist above must not claim that attestations/provenance are already implemented until #133 lands.
